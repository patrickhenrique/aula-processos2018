...
import br.edu.cesmac.bancomgr.dialogo.ObterExtratoGeralUIController;
...
public class UIObterExtratoGeralUtil{
	private ObterExtratoGeralUIController controller;
	...
	public UIObterExtratoGeralUtil() {
		initializeIHC();
	}
