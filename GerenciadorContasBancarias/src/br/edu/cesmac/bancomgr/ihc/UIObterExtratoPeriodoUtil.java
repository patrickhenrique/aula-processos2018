...
import br.edu.cesmac.bancomgr.dialogo.ObterExtratoPeriodoUIController;
...
public class UIObterExtratoPeriodoUtil{
	private ObterExtratoPeriodoUIController controller;
	...
	public UIObterExtratoPeriodoUtil() {
		initializeIHC();
	}
